                ...
                <button @click="toggleTheme"
                    ...
                    <svg x-show="!dark" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 3v1m0 16v1m8.66-8.66l-.707.707M4.34 4.34l.707.707M21 12h-1M4 12H3m16.66 4.66l-.707-.707M4.34 19.66l.707-.707M12 5a7 7 0 100 14 7 7 0 000-14z" />
                    </svg>
                    <!-- Luna -->
                    <svg x-show="dark" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor"
                        viewBox="0 0 20 20">
