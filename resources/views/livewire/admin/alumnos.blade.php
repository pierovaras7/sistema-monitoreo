<div class="custom-px">
    ...
    <div x-data="{ modalAlumno: false, showNotification: false, timeout: null }" 
        ...
        <div class="flex flex-col sm:flex-row sm:space-x-4">
            ...
            <button 
                @click="$wire.call('abrirModalAgregar').then(() => modalAlumno = true)"
        ...
        <div x-show="modalAlumno" 
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div wire:key="alumno-form-{{ $modoEdicion ? 'edit' : 'add' }}" class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    <!-- Modal header -->
                    ...
                    @foreach ($alumnos as $alumno)
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4 flex items-center gap-3 justify-center">
                                <!-- Botón Editar -->
                                <button 
                                    @click="$wire.call('editar', {{ $alumno->id }}).then(() => modalAlumno = true)"
