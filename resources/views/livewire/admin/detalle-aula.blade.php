                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg my-2">
                        <table class="w-full text-sm text-gray-500 dark:text-gray-400 text-center">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="px-2 py-2 cursor-pointer" wire:click="sortBy('nombre')">
                                        NOMBRE
                                        @if ($sortField === 'nombre')
                            ...
                            <div wire:key="sesion-form-add" class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <form class="p-4 md:p-5" wire:submit.prevent="guardarSesion" x-data>
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2">
                                            <label for="link_reunion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link de Reunión (opcional)</label>
                                            ...
                                            @error('link_reunion') <span class="text-red-600 text-xs">{{ $message }}</span> @enderror
                                        </div>
