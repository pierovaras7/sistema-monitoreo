                    ...
                    @forelse ($aula->sesiones as $sesion)
                        <li class="mb-10 ms-4">
                            ...
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                                {{ \Carbon\Carbon::parse($sesion->created_at)->translatedFormat('M Y') }}
                            </time>
                            ...
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500 block">
                                Inicio: {{ \Carbon\Carbon::parse($sesion->fecha_inicio)->translatedFormat('d M Y - h:i A') }}
                            </time>
                            <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500 block">
                                Termino: {{ \Carbon\Carbon::parse($sesion->fecha_fin)->translatedFormat('d M Y - h:i A') }}
                            </time>
                            <!-- Estado de la sesión -->
                            @php
                                $estado = '';
                            ...
                            <a href="{{ route('admin.asistencias', ['sesionId' => $sesion->id]) }}"
                                class="inline-flex items-center gap-2 text-green-600 dark:text-green-400 hover:text-green-700 group"
                                title="Ver Detalles">
                                <div
                                    class="p-1 rounded-full group-hover:bg-green-100 dark:group-hover:bg-green-900 transition">
                                ...
                                <span>Link de registro asistencia</span>
                            </a>
