<div class="custom-px">
    ...
    @if (session()->has('message'))
        <div x-show="showNotification" x-transition x-cloak
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-2 mt-6">
        <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
            ...
            <div x-data="{ modalAlumno: false, showNotification: false, timeout: null }"
                ...
                <div class="flex flex-col sm:flex-row sm:space-x-4 items-center justify-between">
                    <!-- Botón para abrir el modal -->
                    <button @click="$wire.call('abrirModalAgregarAlumno').then(() => modalAlumno = true)"
                        class="my-5 block text-white  md:text-md bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-1/6 flex items-center justify-center space-x-2"
                        type="button">
                    ...
                    <!-- Componente de subir Excel -->
                    <livewire:subir-excel :aulaId="$aulaId"/>
                        ...
                        <div class="relative w-full">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6 m-1">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div x-show="modalAlumno" x-transition
                    ...
                    style="display: none;" @keydown.escape.window="modalAlumno = false"
                    @click.self="modalAlumno = false">
                            ...
                            <form class="p-4 md:p-5" wire:submit.prevent="guardarAlumno" x-data="{ showError: false }">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input wire:model.live="telefono" type="text" name="telefono"
                                            id="telefono"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg my-2">
                        <table class="w-full text-sm text-gray-500 dark:text-gray-400 text-center">
                            <thead
                                ...
                                <tr>
                                    <th scope="col" class="px-2 py-2 cursor-pointer"
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div x-data="{ modalSesion: false, showNotification: false, timeout: null }"
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-4">
                        <!-- Botón para abrir el modal -->
                        <button @click="$wire.call('abrirModalSesion').then(() => modalSesion = true)"
                    ...
                    <div x-show="modalSesion" x-transition
                        class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50"
                        style="display: none;" @keydown.escape.window="modalSesion = false"
                        @click.self="modalSesion = false">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <!-- Modal content -->
                            <div wire:key="sesion-form-add"
                                class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                <!-- Modal header -->
                                <div
                                    class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2 sm:col-span-1">
                                            <label for="fecha_inicio"
                                                ...
                                                Inicio</label>
                                            <input wire:model.live="fecha_inicio" type="datetime-local"
                                                id="fecha_inicio"
                                        ...
                                        <div class="col-span-2">
                                            <label for="link_reunion"
                                                ...
                                                de Reunión (opcional)</label>
                                            <input wire:model.live="link_reunion" type="url" id="link_reunion"
            ...
            <div class="p-4">
                <ol class="relative border-s border-gray-200 dark:border-gray-700">
                    @forelse ($aula->sesiones as $sesion)
                        <li class="mb-10 ms-4">
                            <div
                                class="absolute w-3 h-3 bg-blue-500 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900">
                            </div>
